(function(angular) {
	...
	$scope.sections = [
...

		{
			...
			'verbose': {
				entries: [{w: 'Preface',
						   z: 'I do not yet have any professional experience as a coder, but here is pretty much everything else I’ve ever done in a professional (or in case of Wildcat Dispatches, volunteer) capacity, with the exception of some call centre work I did when I was 18 in order to save money to travel in Asia and some miscellaneous freelancing.'},
